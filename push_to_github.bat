@echo off
title Push AgriLink to GitHub
color 0A

echo ========================================================
echo        AGRILINK - PUSH TO GITHUB REPOSITORY
echo ========================================================
echo.
...
git status -s
echo.
echo Pushing commits to origin main (https://github.com/OgDaDDy981/agrilink.git) ...
echo.
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo  Repository: https://github.com/OgDaDDy981/agrilink
    echo ========================================================
) else (
    echo.
    echo ========================================================
